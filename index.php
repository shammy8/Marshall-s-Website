...
<main>
    ...
    <div class="no-background">
        ...
        <p>Talking about adventures, you can see all the places I have been to in my adventure <a href="#google-map">map</a>. I have been all over the UK: from the North of Scotland to Lands End. You can also hop over to my <a href=https://www.instagram.com/marshallmattersthebc target="_blank">Instagram</a> and follow it, I am getting famous so please no puparazzi.</p>
    ...
    <!--Christmas Card Form-->
    <div class="no-background" id="christmas">
    ...
    <!--Map-->
    <div class="map-title" id="google-map"  >
        <h1 class="full-title"><a href="#google-map">M Y &nbsp; &nbsp; A D V E N T U R E S</a></h1>
        <h1 class="half-adventure-title"><a href="#google-map">A D V E N T U R E S</a></h1>
    </div>
    <div id="map"></div>
